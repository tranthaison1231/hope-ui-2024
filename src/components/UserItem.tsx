...
function UserItem({ children }: { children: React.ReactNode }) {
  return (
    <div className="text-[#232D42] rounded-lg  bg-white p-4 shadow-lg font-medium children:flex children:items-center children:pb-4">
      ...
      <div>
        ...
        <NodeUserItem className="fill-[#C33E2E] z-30 -ml-2"><Plus className="m-[6px]"/></NodeUserItem>
      </div>
    </div>
  );
}
